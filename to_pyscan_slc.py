...
ds_january = slice_ds(ds, lats, longs, january)
ds_october = slice_ds(ds, lats, longs, october)
...
# write to nc files
ds_january.to_netcdf(f"{RESULTS_PATH}/pm_slc_2016_january.nc")
ds_october.to_netcdf(f"{RESULTS_PATH}/pm_slc_2016_october.nc")
